...
},
{
    ...
    match: ["Vi"],
    lang: {
        //Vietnamese by MRawen.
        saveBtn: "Lưu",
        saveName: "Tên khi lưu",
        saveNameTip: "Cách đặt tên cho tệp ảnh khi lưu",
        default: "Mặc định",
        textFirst: "Thông tin trước nếu có",
        onlyUrl: "Chỉ URL",
        urlAndText: "URL + Thông tin",
        download: "Tải xuống",
        saveBtnTips: "Có thể cần phải làm mới trang để một số tùy chọn có hiệu lực",
        additionalFeature: "Tính năng bổ sung, kích hoạt khi nhấn Alt",
        invertAdditionalFeature: "Đảo ngược phím tắt, sử dụng tính năng bổ sung theo mặc định",
        copy: "Sao chép liên kết",
        copyImg: "Sao chép dữ liệu hình ảnh",
        openInNewTab: "Mở trong tab mới",
        closeBtn: "Hủy",
        invertBtn: "Đảo ngược",
        compareBtn: "So sánh",
        selectAllBtn: "Chọn tất cả",
        closeBtnTips: "Hủy bỏ các thay đổi và khôi phục cài đặt trước đó",
        resetLink: "Khôi phục cài đặt mặc định",
        resetLinkTips: "Hủy bỏ các thay đổi và khôi phục tất cả cài đặt mặc định",
        share: "Chia sẻ",
        suitLongImg: "Hiển thị hình ảnh dài trong cửa sổ cuộn",
        globalkeys: "Phím tắt để kích hoạt xem trước",
        globalkeysPress: "Nhấn để kích hoạt",
        globalkeysHold: "Giữ để kích hoạt",
        globalkeysType: "Phương pháp kích hoạt xem trước: ",
        closeAfterPreview: "Đóng cửa sổ hình ảnh sau khi xem trước",
        loadAll: "Tải thêm trang",
        loadedAll: "Đã tải xong",
        loading: "Đang tải ...",
        loadAllTip: "Tải hình ảnh ở trang tiếp theo",
        viewmoreEndless: "Tải thêm hình ảnh trong chế độ xem thêm khi cuộn xuống cuối",
        fiddle: "Thao tác",
        fiddleTip: "Mở ảnh hiện tại trong cửa sổ động để thực hiện các thao tác phức tạp",
        addImageUrls: "Thêm ảnh",
        addImageUrlsTips: "Thêm ảnh vào bộ sưu tập thông qua URL",
        openImages: "Hình ảnh từ máy tính",
        openImagesTips: "Nhấp để nhập hình ảnh từ máy tính",
        closeFirst: "Đóng bộ sưu tập xem trước",
        collect: "Bộ sưu tập",
        collected: "Đã thêm vào bộ sưu tập",
        exitCollection: "Thoát chế độ sưu tập",
        exitCollectionTip: "Thoát khỏi bộ sưu tập",
        noCollectionYet: "Bạn chưa có hình ảnh nào trong bộ sưu tập",
        collectDetail: "Mô tả",
        collectDetailTip: "Thêm mô tả cho bộ sưu tập yêu thích của bạn",
        playSlide: "Chạy trình chiếu",
        slideGap: "Khoảng cách (s)",
        slideGapTip: "Khoảng thời gian, tính bằng giây",
        slideBack: "Chạy ngược từ cuối lên đầu",
        slideBackTip: "Chạy trình chiếu ảnh từ cuối lên đầu",
        slideWait: "Chờ tải hình ảnh",
        slideWaitTip: "Đếm ngược bắt đầu sau khi ảnh được tải hoàn toàn.",
        slideSkipError: "Bỏ qua ảnh lỗi",
        slideSkipErrorTip: "Bỏ qua ảnh không thể tải được",
        type: "Thể loại",
        typeTip: "Sắp xếp ảnh theo quy tắc. Bỏ chọn một quy tắc sẽ ẩn đi những ảnh tương ứng",
        showWithRules: "Bắt buộc hiển thị thanh công cụ",
        showWithRulesTip: "Hiển thị thanh công cụ nếu ảnh phù hợp với quy tắc, bất kể kích thước nào",
        advancedRules: "Quy tắc nâng cao",
        advancedRulesTip: "Phù hợp theo các quy tắc nâng cao",
        tpRules: "Quy tắc ký tự đặc biệt",
        tpRulesTip: "Khớp theo quy tắc ký tự đcặ biệt",
        scaleRules: "Thu phóng",
        scaleRulesTip: "Hình ảnh được tìm tự động đã được thay đổi kích thước",
        noScaleRules: "Không thay đổi kích thước",
        noScaleRulesTip: "Hình ảnh được tìm tự động không được thay đổi kích thước",
        smallRules: "Ảnh nhỏ",
        smallRulesTip: "Ảnh có kích thước thực tế nhỏ hơn #t# pixel ở chiều rộng và chiều cao",
        lockSizeTip: "Khóa kích thước tối đa",
        command: "Lệnh",
        commandTip: "Menu lệnh",
        onlineEdit: "Chỉnh sửa online",
        onlineEditTip: "Sử dụng #t# để chỉnh sửa hình ảnh online",
        openInNewWindow: "Mở trong cửa sổ mới",
        openInNewWindowTip: "Mở hình ảnh trong tab mới",
        findInPage: "Tìm trong Trang",
        findInPageTip: "Cuộn trang đến vị trí ảnh hiện tại",
        viewCollection: "Xem bộ sưu tập",
        viewCollectionTip: "Xem tất cả ảnh đã thêm vào bộ sưu tập",
        inCollection: "Không thể sử dụng trong bộ sưu tập",
        cantFind: "Ảnh không tồn tại trong tài liệu hoặc bị ẩn và không thể được định vị!",
        exportImages: "Mở tất cả ảnh",
        exportImagesTip: "Mở tất cả ảnh từ bộ sưu tập trong tab mới",
        downloadImage: "Tải về tất cả ảnh",
        downloadImageTip: "Tải về tất cả ảnh từ bộ sưu tập (Gợi ý: Sử dụng tùy chọn ZIP để nén)",
        copyImagesUrl: "Sao chép tất cả liên kết hình ảnh",
        copyImagesUrlTip: "Sao chép liên kết của ảnh trong bộ sưu tập vào clipboard của bạn",
        copySuccess: "Đã sao chép #t# liên kết thành công",
        autoRefresh: "Tự động làm mới trang",
        autoRefreshTip: "Khi đã xem hết ảnh mới nhất, trang sẽ tự động cuộn xuống để tải thêm ảnh",
        enterFullsc: "Chuyển sang chế độ toàn màn hình",
        exitFullsc: "Thoát chế độ toàn màn hình",
        config: "Cài đặt",
        openConfig: "Mở cài đặt",
        closeGallery: "Đóng bộ sưu tập",
        returnToGallery: "Quay lại bộ sưu tập",
        picInfo: "Nhấp để sửa đổi",
        picNote: "Chú thích hình ảnh",
        urlFilter: "Bộ lọc liên kết",
        urlFilterTip: "Lọc liên kết bằng từ khóa hoặc biểu thức",
        resolution: "Độ phân giải hình ảnh",
        picNum: "Số lượng ảnh",
        picTips: "Giữ phím CTRL và di chuột qua ảnh để xem ảnh phóng lớn",
        savePageTips: "Nhấn CTRL+S để lưu trang này và tải về tất cả ảnh",
        scaleRatio: "Tỷ lệ phóng ảnh",
        similarImage: "Tìm kiếm bằng ảnh",
        scale: "Phóng to",
        horizontalFlip: "Lật ngang",
        verticalFlip: "Lật dọc",
        actualBtn: "Xem ảnh gốc (A)",
        searchBtn: "Tìm ảnh gốc (S)",
        galleryBtn: "Xem bộ sưu tập (G)",
        currentBtn: "Xem ảnh hiện tại (C)",
        magnifierBtn: "Phóng to bằng Kính lúp (M)",
        picTitle: "Tiêu đề ảnh",
        exportImagesUrl: "Xuất liên kết URL của ảnh",
        exportImagesUrlPop: "Sử dụng Ctrl+C để sao chép liên kết của ảnh",
        beginSearchImg: "#t# bắt đầu tìm hình ảnh ...",
        findNoPic: "Không tìm thấy ảnh gốc",
        findOverBeginLoad: "#t# kết thúc tìm kiếm. Đã tìm thấy #t# ảnh phù hợp, đang tải ảnh đầu tiên... ",
        loadNextSimilar: "Không thể tải ảnh gốc, đang thử tải kết quả tiếp theo... ",
        loadError: "Tải thất bại",
        openHomePage: "Mở trang chủ",
        position: "Vị trí thanh công cụ",
        positionTips: "Nhấn phím ALT để ẩn thanh công cụ",
        topLeft: "Góc trên bên trái",
        topRight: "Góc trên bên phải",
        bottomRight: "Góc dưới bên phải",
        bottomLeft: "Góc dưới bên trái",
        topCenter: "Bên cạnh ảnh",
        bottomCenter: "Dưới ảnh",
        floatBar: "Thanh công cụ",
        previewFollowMouse: "Hiển thị xem trước bên cạnh con trỏ chuột",
        showDelay: "Độ trễ trước khi hiển thị thanh công cụ",
        ms: "mili giây",
        hide: "Ẩn thanh công cụ",
        hideDelay: "Độ trễ trước khi ẩn thanh công cụ",
        forceShow: "Hiển thị thanh công cụ trên ảnh chưa được phóng lớn",
        forceShowTip: "Hiển thị thanh công cụ khi kích thước ảnh chưa được phóng lớn vượt quá kích thước được đặt",
        sizeLimitOr: "Hiển thị nếu khớp với chiều cao hoặc rộng",
        px: "px",
        minSizeLimit: "Hiển thị thanh công cụ trên hình ảnh phóng lớn",
        minSizeLimitTip: "Hiển thị thanh công cụ khi kích thước ảnh được phóng lớn (kích thước gốc khác với kích thước thực tế) vượt quá kích thước được định nghĩa ở đây",
        defaultSizeLimit: "Giới hạn kích thước mặc định cho bộ sưu tập",
        listenBg: "Xem hình ảnh ở chế độ nền",
        backgroundColor: "Màu nền",
        listenBgTip: "Hiển thị thanh công cụ ở chế độ nền",
        butonOrder: "Sắp xếp các biểu tượng thanh công cụ",
        keysEnable: "Phím tắt để kích hoạt công cụ",
        keysActual: "Mở ảnh gốc",
        keysActualTip: "Nhấn phím này để mở ảnh gốc",
        keysSearch: "Tìm ảnh gốc",
        keysSearchTip: "Nhấn phím này để tìm kiếm ảnh gốc",
        headSearchTip: "Sử dụng một trong những trang web sau để tìm kiếm ảnh tương tự",
        headSearchAll: "Tìm kiếm trên tất cả các trang web",
        keysCurrent: "Mở ảnh hiện tại",
        keysCurrentTip: "Nhấn phím này để mở ảnh hiện tại",
        keysMagnifier: "Mở kính lúp",
        keysMagnifierTip: "Nhấn nút này để sử dụng kính lúp",
        keysGallery: "Mở ảnh trong bộ sưu tập",
        keysGalleryTip: "Nhấn phím này để mở ảnh trong bộ sưu tập",
        openGallery: "Mở bộ sưu tập",
        magnifier: "Kính lúp",
        magnifierRadius: "Kích thước mặc định của kính lúp",
        magnifierWheelZoomEnabled: "Cho phép phóng to bằng con lăn chuột",
        magnifierWheelZoomRange: "Tỉ lệ phóng của kính lúp",
        gallery: "Bộ sưu tập",
        galleryFitToScreen: "Phóng ảnh để vừa màn hình",
        galleryFitToScreenSmall: "Phóng ảnh để vừa màn hình, ngay cả khi ảnh nhỏ",
        galleryFitToScreenTip: "Phóng ảnh để vừa màn hình mà không để nó bị khuất tầm nhìn",
        galleryScrollEndToChange: "Chuyển ảnh khi cuộn đến cuối",
        galleryScrollEndToChangeTip: "Tự động chuyển sang hình ảnh tiếp theo khi cuộn xuống cuối một ảnh dài. Có hiệu lực sau khi hủy tùy chọn trước đó",
        galleryExportType: "Sắp xếp mặc định khi xuất hình ảnh",
        grid: "Sắp xếp lưới",
        gridBig: "Sắp xếp theo thứ tự gốc",
        list: "Sắp xếp danh sách",
        galleryAutoLoad: "Tự động tải thêm ảnh ở trang tiếp theo",
        galleryLoadAll: "Tự động xử lý trang khi tải thêm ảnh",
        galleryLoadAllTip: "Tải quá nhiều ảnh trên một trang có thể ảnh hưởng đến trải nghiệm của bạn",
        galleryDownloadWithZip: "Nén thành file ZIP khi tải xuống",
        galleryDownloadWithZipAlert: "Đang nén, vui lòng đợi một chút",
        galleryScaleSmallSize1: "Nếu chiều cao và chiều rộng thực tế nhỏ hơn ",
        galleryScaleSmallSize2: "Pixels, ảnh sẽ được phân loại là nhỏ",
        galleryShowSmallSize: "Hiển thị ảnh kích thước nhỏ theo mặc định",
        galleryTransition: "Hiển thị hiệu ứng chuyển ảnh trong bộ sưu tập",
        gallerySidebarPosition: "Vị trí thanh bên",
        bottom: "Bên dưới",
        right: "Bên phải",
        left: "Bên trái",
        top: "Bên trên",
        gallerySidebarSize: "Kích thước",
        gallerySidebarSizeTip: "Chiều cao của thanh bên (nếu là ngang) hoặc chiều rộng (nếu là dọc)",
        galleryMax1: "Kích thước tối đa khi tải trước",
        galleryMax2: "Ảnh (trước và sau)",
        galleryAutoZoom: "Zoom trở lại 100% (Chrome)",
        galleryAutoZoomTip: "Khi Zoom, thay đổi mức thu phóng của ảnh và thanh bên về 100%, tăng diện tích hiển thị (Chrome)",
        galleryDescriptionLength1: "Số ký tự tối đa cho chú thích là",
        galleryDescriptionLength2: "Ký tự",
        galleryAutoOpenSites: "Liên kết các URL để mở thư viện tự động. Bắt đầu bằng @ cho chế độ xem thêm. Viết một quy tắc trên mỗi dòng",
        autoOpenViewmore: "Tự động xem thêm khi mở thư viện",
        galleryViewmoreLayout: "Bố cục chế độ xem thêm",
        gallerySearchData: "Quy tắc tìm kiếm hình ảnh của trang web, làm trống để khôi phục",
        galleryEditSite: "Chỉnh sửa trang web online",
        imgWindow: "Cửa sổ ảnh",
        imgWindowFitToScreen: "Điều chỉnh ảnh cho vừa với màn hình",
        imgWindowFitToScreenTip: "Điều chỉnh ảnh cho vừa với màn hình mà không để nó bị khuất tầm nhìn",
        imgWindowFitToScreenWhenSmall: "Điều chỉnh ảnh cho vừa với màn hình, ngay cả khi nó nhỏ",
        imgWindowDefaultTool: "Công cụ được chọn mặc định khi mở cửa sổ ảnh",
        hand: "Di chuyển",
        rotate: "Xoay",
        zoom: "Kính lúp",
        imgWindowEscKey: "Đóng bằng phím Esc",
        imgWindowDblClickImgWindow: "Nhấp đúp để đóng",
        imgWindowClickOutside: "Nhấp ra ngoài để đóng",
        imgWindowClickOutsideTip: "Chỉ có tác dụng khi lớp phủ được chọn",
        none: "Không",
        click: "Nhấp một lần",
        dblclick: "Nhấp đúp",
        imgWindowOverlayerShown: "Lớp phủ",
        imgWindowOverlayerColor: "Màu sắc và độ mờ của lớp phủ",
        imgWindowShiftRotateStep1: "Giữ phím Shift để xoay mỗi ",
        imgWindowShiftRotateStep2: "độ",
        imgWindowMouseWheelZoom: "Cho phép phóng to bằng con lăn chuột",
        imgWindowZoomRange: "Phạm vi thu phóng",
        imgWindowZoomRangeTip: "Tỷ lệ phóng (phải là số dương)",
        others: "Khác",
        waitImgLoad: "Đợi hình ảnh tải trước khi thực hiện các thao tác như phóng to",
        waitImgLoadTip: "Nhấn Ctrl bạn có thể tạm thời bỏ qua cài đặt này",
        debug: "Chế độ gỡ lỗi",
        customRules: "Quy tắc tùy chỉnh cho ảnh lớn",
        firstEngine: "Tìm kiếm ưu tiên (đầu tiên)",
        refreshWhenError: "Lỗi đọc, bấm để tải lại",
        switchSlide: "Chuyển đổi thanh bên",
        viewmore: "Xem thêm",
        countDown: "Đếm ngược",
        customLang: "Tùy chỉnh ngôn ngữ ",
        defaultLang: "Tự động",
        hideIcon: "Ẩn thanh công cụ",
        initShow: "Đảo phím tắt để xem trước theo mặc định",
        stayOut: "Cho phép thanh công cụ nằm ngoài ảnh",
        galleryDownloadGap: "Khoảng thời gian tải xuống",
        galleryDisableArrow: "Tắt các phím mũi tên",
        positionFixed: "Vị trí cố định",
        switchStoreLoc: "Vị trí bộ nhớ khi chuyển đổi"
    }
}
];
var langList = {};
